...
def main(header,page):
    ...
    df.to_csv(p + '/' + 'gap1.csv', mode='a+', index=False, encoding='utf-8', header=header)
    ...
    # print('共耗時' % execution_time)
    print('#' * 50)
if __name__ == '__main__':
   #main(header=True,page=1)#第一次跑需要先跑這個
   main(header=False,page=20)#第一次以後都跑這個
'''
